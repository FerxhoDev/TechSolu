...
namespace CapaPresentacion
{
    public partial class frmClientes : Form
    {
        ...
        private void frmClientes_Load(object sender, EventArgs e)
        {
            ...
            {
                gDgvData.Rows.Add(new object[] { "",item.idCliente, item.Nombre, item.Telefono, item.Direccion, item.Correo
        ...
        private void gBtnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                idCliente = Convert.ToInt32(gTxtId.Text),
            ...
            if (objCliente.idCliente == 0)
            {
                ...
                if (idClientegenerado != 0)
                {
                    ...
                    gDgvData.Rows.Add(new object[] {"",idClientegenerado,gTxtNombre.Text,gTxtTelefono.Text,gTxtDireccion.Text,GtxtCorreo.Text
                });
                    Limpiar();
                }
                else
